  ...
  return (
    <section className="section-spacing bg-gradient-to-b from-background via-card/20 to-background relative overflow-hidden">
      ...
      <div className="container-elegant relative z-10">
        ...
        {/* Mapa */}
        <div
          className="relative mb-8 max-w-5xl mx-auto animate-fade-in-up"
        ...
        {/* Endereço + Botões */}
        <div
          className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 glass-effect rounded-2xl p-8 border border-border/50 shadow-xl animate-fade-in-up"
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3 text-sm font-semibold rounded-xl  text-white bg-primary-light hover:shadow-glow transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
            >
